...
Achou que não ia mais ter post? Acho errado, programador (ou curioso)! Hoje, análise de emoções e API.
...
Segundo, se você não sabe, ainda, o que é [Choque de Cultura](https://www.youtube.com/watch?v=4u1w1UnqI0Y), clique aí e deem uma olhada em um humor bem peculiar.
...
# c('dplyr', 'tidyr', 'tibble', 'ggplot2', 'scales', 'gridExtra', 'grid', 'imager') 
...
# top (ponto mais alto), left(ponto a esquerda), width (largura), e height (altura)
